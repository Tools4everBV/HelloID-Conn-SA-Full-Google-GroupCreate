...
#Global variable #2 >> GoogleClientSecret
$tmpName = @'
GoogleClientSecret
'@ 
$tmpValue = "" 
...
#Global variable #4 >> GoogleRefreshToken
$tmpName = @'
GoogleRefreshToken
'@ 
$tmpValue = "" 
...
<# Begin: Dynamic Form "Google Group - Create" #>
$tmpSchema = @"
[{"label":"Details","fields":[{"key":"name","templateOptions":{"label":"Name","required":true,"minLength":5,"pattern":"^[A-Za-z0-9._-]{6,50}$"},"validation":{"messages":{"pattern":"Allowed characters: a-z 0-9 . _ - \nMinimal 6, maximum 50 characters"}},"type":"input","summaryVisibility":"Hide element","requiresTemplateOptions":true},{"key":"description","templateOptions":{"label":"Description"},"type":"input","summaryVisibility":"Show","requiresTemplateOptions":true},{"key":"email","templateOptions":{"label":"Email","pattern":"(?:[a-z0-9!#$%\u0026\u0027*+/=?^_{|}~-]+(?:\\.[a-z0-9!#$%\u0026\u0027*+/=?^_{|}~-]+)*|\"(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21\\x23-\\x5b\\x5d-\\x7f]|\\\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])*\")@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\\[(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?|[a-z0-9-]*[a-z0-9]:(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21-\\x5a\\x53-\\x7f]|\\\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])+)\\])"},"validation":{"messages":{"pattern":"Invalid email address"}},"type":"email","summaryVisibility":"Hide element","requiresTemplateOptions":true}]}]
"@ 
...
'@; 
	...
	$tmpVariables = @'
[{"name":"description","value":"{{form.description}}","secret":false,"typeConstraint":"string"},{"name":"email","value":"{{form.email}}","secret":false,"typeConstraint":"string"},{"name":"name","value":"{{form.name}}","secret":false,"typeConstraint":"string"}]
'@ 
